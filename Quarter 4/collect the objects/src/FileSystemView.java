...
public abstract class FileSystemView {
    ...
    private static FileSystemView windowsFileSystemView = null;
    private static FileSystemView unixFileSystemView = null;
    //static FileSystemView macFileSystemView = null;
    private static FileSystemView genericFileSystemView = null;
     ...
     */
    private File[] getFiles(File dir, boolean useFileHiding) {
     ...
     * @since 1.4
     */
    File createFileSystemRoot(File f) {
...
class WindowsFileSystemView extends FileSystemView {
    ...
    public boolean isFloppyDrive(final File dir) {
        String path = AccessController.doPrivileged((PrivilegedAction<String>) dir::getAbsolutePath);
